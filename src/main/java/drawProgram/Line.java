...
public class Line extends Geometry {
	...
	public void checkInput(String[] input) {
		...
		// validates if the values inserted create only an horizontal or a vertical line
		if ((x1 != x2) && (y1 != y2))
			throw new IllegalArgumentException("please insert an horizontal or vertical line");
		...
		if (x1 == x2 && y1 == y2) {
			...
			throw new IllegalArgumentException("Please insert different point coordinates to create a line");
		}
